...
class Header {
	...
	function createHtml( $data ) {
		...
		$mnList = $cat->menuList();
	?>
		<div id="head-top-line">
			<div id="head-top-line-content">
				<div id="head-top-left">
					<?php if ( $data['current-page'] != 'product-page' ) echo SITE_DESC ?>
            		<?php if ( $data['current-page'] == 'product-page' ) echo $data['product-detail']['keyword'] ?>
				</div>
				<div id="head-top-right">
					<ul>
		            <li><a href="<?php echo HOME_URL?>category-list<?php echo FORMAT?>">Categories</a></li>
		            <li><a href="<?php echo HOME_URL?>brand-list<?php echo FORMAT?>">Brands</a></li>
	        	</ul>
				</div>
			</div>
		</div>
		<div id="head-middle">
			<div id="sitename"><a href="<?php echo HOME_LINK?>"><?php echo strtoupper( SITE_NAME )?></a></div>
			<div id="search">
				<div class="search-bar">
			        <form role="search" action="<?php echo HOME_URL?>search/1/" method="get">
